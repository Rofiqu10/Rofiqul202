...
░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░      ░▒▓█▓▒░ 
 ...
 {X5}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{X2}【{X5}✦{X2}】{Y}DEVELOPER   {B}»----{A}➤ {G3}Rofiqul hasan Rafi
{X2}【{X5}✦{X2}】{Y}GITHUB      {B}»----{A}➤ {G3}owner:Rofiqu10 
{X2}【{X5}✦{X2}】{Y}TELEGRAM    {B}»----{A}➤ {G3}@rofiqulrafi
...
def U7P4L():
    os.system('clear');os.system("https://github.com/");os.system("clear");print(logo);print(f'{B}【{A}01{B}】{G2}ENCRYPT BASE16');print(f'{B}【{A}02{B}】{G2}ENCRYPT BASE32');print(f'{B}【{A}03{B}】{G2}ENCRYPT BASE64 ');print(f'{B}【{A}04{B}】{G2}ENCRYPT MARSHAL');print(f'{B}【{A}05{B}】{G2}ENCRYPT MARSHAL-ZLIB-BASE16');print(f'{B}【{A}06{B}】{G2}ENCRYPT MARSHAL-ZLIB-BASE32');print(f'{B}【{A}07{B}】{G2}ENCRYPT MARSHAL-ZLIB-BASE64');print(f'{B}【{A}08{B}】{G1}FIND MORE TOOLS ');print(f'{B}【{A}00{B}】{R}EXIT PROGRAMME ')
    print(f' {X5}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
    ...
    if u7p4l in ['1','01','A','a']:
    	...
    	os.system('xdg-open https://github.com/owner:Rofiqu10 ');menu()
